...
// TextBtn section component – shows a headline, supporting text, and a CTA button
export const TextBtn = ({ headline, body }) => {
  return (
    <section className="wrapper text-center my-5">
